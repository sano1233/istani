    ...
    <div className="panel grid-2">
      <div className="card chat-card">
        <div className="card-header">
          <h2>AI Chat</h2>
          <p className="muted">
            Ask about bookings, social posts, or general questions.
          </p>
        </div>
      ...
      <div className="card voice-card">
        <div className="card-header">
          ...
          <p className="muted">
            Talk to the same AI using your microphone.
          </p>
        </div>
        <div className="voice-body">
          <p className="muted">
            This runs fully in your browser using the Web Speech API. No extra
            accounts or billing.
          </p>
          <button
          ...
          <p className="tips">
            Tip: Use Chrome on desktop for the best speech recognition.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="panel single">
      <div className="card">
        <div className="card-header">
          ...
          <p className="muted">
            Draft content once, let the backend handle posting or scheduling.
          </p>
        </div>
        ...
        <p className="muted small">
          Note: For real Mastodon posting, set <code>MASTODON_BASE_URL</code>{" "}
          and <code>MASTODON_ACCESS_TOKEN</code> in <code>server/.env</code>.
        </p>
      </div>
    </div>
  );
    ...
    <div className="panel grid-2">
      <div className="card">
        <div className="card-header">
          ...
          <p className="muted">
            These are sample time slots from the backend. Later you can wire
            this to Google Calendar or a real schedule.
          </p>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <h2>Book a Slot</h2>
          <p className="muted">
            Pick a time on the left, then confirm the booking here.
          </p>
        </div>
        ...
        {bookingStatus && (
          <div
            className={`status ${
              bookingStatus.ok ? "status-ok" : "status-bad"
            }`}
          >
