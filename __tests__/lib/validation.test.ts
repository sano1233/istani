...
describe('validateStringLength', () => {
  ...
  it('should throw for strings too long', () => {
    ...
    expect(() => validateStringLength('hello world', 1, 5)).toThrow('must be no more than 5 characters')
  })
...
describe('validateArrayLength', () => {
  ...
  it('should throw for arrays too long', () => {
    ...
    expect(() => validateArrayLength([1, 2, 3, 4, 5, 6], 1, 5)).toThrow('must have no more than 5 items')
  })
})
...
describe('validateEnum', () => {
  ...
  it('should throw for invalid enum values', () => {
    ...
    expect(() => validateEnum('invalid', ['admin', 'user', 'guest'])).toThrow('must be one of: admin, user, guest')
  })
...
describe('validateFile', () => {
  ...
  it('should validate allowed MIME types', () => {
    ...
    expect(() =>
      validateFile(file, { allowedTypes: ['image/png', 'image/jpeg'] })
    ).toThrow(ValidationError)
    expect(() =>
      validateFile(file, { allowedTypes: ['image/png', 'image/jpeg'] })
    ).toThrow('File type must be one of')
  })

  it('should validate allowed extensions', () => {
    const file = createMockFile(1024, 'text/plain', 'test.txt')
    expect(() =>
      validateFile(file, { allowedExtensions: ['png', 'jpg'] })
    ).toThrow(ValidationError)
    expect(() =>
      validateFile(file, { allowedExtensions: ['png', 'jpg'] })
  ...
  it('should handle files without extension', () => {
    ...
    expect(() =>
      validateFile(file, { allowedExtensions: ['txt'] })
    ).toThrow(ValidationError)
  })
  ...
  it('should be case-insensitive for extensions', () => {
    ...
    expect(() =>
      validateFile(file, { allowedExtensions: ['png'] })
    ).not.toThrow()
  })
