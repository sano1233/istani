      ...
      <section className="relative flex items-center justify-center h-screen px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="mb-8 text-lg text-white/70 max-w-2xl mx-auto">
            Istani combines cutting-edge exercise science, personalized nutrition coaching, and
            advanced progress tracking to help you achieve sustainable fitness transformations.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              We cut through the fitness industry noise with evidence-based methodologies proven by
              peer-reviewed research and real athlete outcomes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 border rounded-xl border-white/10 bg-white/5 hover:bg-white/10 transition-all">
              ...
              <p className="text-white/70 mb-4">
                Every training program is built on peer-reviewed research from exercise physiology,
                biomechanics, and sports nutrition studies.
              </p>
            ...
            <div className="p-8 border rounded-xl border-white/10 bg-white/5 hover:bg-white/10 transition-all">
              ...
              <p className="text-white/70 mb-4">
                Third-party tested supplements with transparent labeling. No proprietary blends, no
                false promises—just proven ingredients at effective doses.
              </p>
              <ul className="text-white/60 space-y-2 text-sm">
            ...
            <div className="p-8 border rounded-xl border-white/10 bg-white/5 hover:bg-white/10 transition-all">
              ...
              <p className="text-white/70 mb-4">
                Track every metric that matters: strength gains, body composition changes, workout
                volume, nutrition adherence, and recovery markers.
              </p>
              <ul className="text-white/60 space-y-2 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-white/80">
                <p className="text-lg">
                  <span className="text-primary font-bold">Progressive Overload:</span> Systematic
                  increases in training stimulus through volume, intensity, or frequency to drive
                  continuous adaptation.
                </p>
                <p className="text-lg">
                  <span className="text-primary font-bold">Periodization:</span> Structured training
                  phases that optimize hypertrophy, strength, and recovery across mesocycles and
                  macrocycles.
                </p>
                <p className="text-lg">
                  <span className="text-primary font-bold">Individual Response:</span> Personalized
                  programming based on training age, recovery capacity, and biomechanical factors.
                </p>
                <p className="text-lg">
                  <span className="text-primary font-bold">Recovery Science:</span> Deloads, sleep
                  optimization, and nutrition timing to maximize muscle protein synthesis and
            ...
            <div className="space-y-6">
              <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                ...
                <p className="text-white/70">
                  6-20 rep ranges, 3-5 sets per exercise, controlled tempo with 1-2 minutes rest for
              ...
              <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                ...
                <p className="text-white/70">
                  1-6 rep ranges, compound movements, longer rest periods (3-5 min) for maximal
                  neural adaptation and force production.
                </p>
              </div>
              <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                <h4 className="text-xl font-bold text-primary mb-2">Metabolic Conditioning</h4>
                <p className="text-white/70">
                  High-intensity interval training designed to improve VO2 max and lactate threshold
                  without interfering with strength gains.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 py-24 bg-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Forget fad diets. Our nutrition approach is built on energy balance, macronutrient
              optimization, and meal timing research.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="p-8 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                Optimal protein intake for muscle protein synthesis based on meta-analyses of
            ...
            <div className="p-8 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                Essential for hormone production, vitamin absorption, and satiety while allowing
            ...
            <div className="p-8 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                Carbohydrate intake scaled to training volume for glycogen repletion and performance
                optimization.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/5 p-8 rounded-xl border border-white/10">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-white/80">
              <div>
                <p className="mb-4">
                  <span className="font-bold text-primary">Energy Balance:</span> Caloric intake
                  aligned with goals—controlled deficit for fat loss (-300 to -500 kcal), surplus
                  for muscle gain (+200 to +400 kcal).
                </p>
                <p>
                  <span className="font-bold text-primary">Nutrient Timing:</span> Protein
                  distributed across 4-6 meals for elevated muscle protein synthesis throughout the
                  day. Carbs prioritized around training.
                </p>
              </div>
              <div>
                <p className="mb-4">
                  <span className="font-bold text-primary">Micronutrients:</span> Emphasis on
                  nutrient-dense whole foods to meet vitamin and mineral requirements for optimal
                  health and performance.
                </p>
                <p>
                  <span className="font-bold text-primary">Adherence:</span> Flexible dieting
                  approach allowing 80-90% whole foods with room for food preferences to ensure
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/60 text-sm">
                Personalized training programs based on your experience, goals, and available
                equipment.
              </p>
            </div>
            ...
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/60 text-sm">
                Macro-optimized meal plans with recipes and grocery lists tailored to your caloric
                needs.
              </p>
            </div>
            ...
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/60 text-sm">
                Visual analytics showing strength gains, body composition changes, and training
                volume.
              </p>
            </div>
            ...
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
              ...
              <p className="text-white/60 text-sm">
                Intelligent form analysis and training recommendations powered by machine learning.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-24 bg-gradient-to-br from-primary/20 to-background-dark">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mb-8 text-xl text-white/80">
            Join thousands of athletes who have transformed their physiques with evidence-based
      ...
      <section className="px-4 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-white/70 mb-8">
            Share your thoughts, questions, or fitness journey with us
          </p>
