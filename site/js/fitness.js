...
function startProgram(programType) {
    ...
    // Show notification
    showNotification(`🎉 Starting ${programType} program! Opening AI Coach to create your personalized plan...`);
...
function startTrial() {
    ...
    setTimeout(() => {
        alert('Free trial registration would open here. For demo purposes, you can start chatting with the AI Coach!');
        openAICoach();
    }, 1000);
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.program-card-ios, .nutrition-card, .principle-card, .ai-feature').forEach(el => {
        el.style.opacity = '0';
