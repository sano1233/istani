...
// UserData interface removed - not currently used
  ...
  const motivationalMessages = [
    {
      ...
      content:
        'Every morning is a new opportunity to become a better version of yourself. Your body is capable of amazing things!',
    },
    {
    ...
    },
    {
      ...
      content:
        'Success is the sum of small efforts repeated day in and day out. Today is another opportunity to build your success!',
    },
    {
      title: '⚡ Unleash Your Potential!',
      content:
        "Your only limit is you. Break through your barriers and show yourself what you're truly capable of!",
    },
  ];
...
function getExercisesForType(type: string): any {
  const exerciseDatabase: Record<string, any> = {
    strength: {
      ...
      cooldown: [{ name: 'Static Stretching', duration: 10 }],
    },
    cardio: {
      warmup: [{ name: 'Walking', duration: 5 }],
      main: [
    ...
    flexibility: {
      warmup: [{ name: 'Light Movement', duration: 5 }],
      main: [
        { name: 'Yoga Flow', duration: 25 },
        { name: 'Deep Stretching', duration: 15 },
      ],
      cooldown: [{ name: 'Meditation', duration: 5 }],
    },
  };
